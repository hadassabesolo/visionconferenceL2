...
<body>
    ...
    <main>
            ...
            if (isset($_SESSION['rapport_malika']) && !empty($_SESSION['rapport_malika'])) {
                
                // On inverse le tableau pour afficher le message le plus récent tout en haut
                $rapportsInverses = array_reverse($_SESSION['rapport_malika']);
        ...
        <form class="rapport" action="espace_malika.php" method="POST">
            ...
            <div class="org">
                <h3>2.  Consultation</h3>
                  ...
                  <div class="org">
                   ...
                   <form method="POST" action="espace_malika.php">
