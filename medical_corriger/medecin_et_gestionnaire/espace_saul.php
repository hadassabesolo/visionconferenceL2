...
<body>
    ...
    <main>
            ...
            if (isset($_SESSION['rapport_saul']) && !empty($_SESSION['rapport_saul'])) {
                
                // On inverse le tableau pour afficher le message le plus récent tout en haut
                $rapportsInverses = array_reverse($_SESSION['rapport_saul']);
        ...
        <form class="rapport" action="espace_saul.php" method="POST">
            ...
            <div class="org">
                <h3>2.  Consultation</h3>
                   ...
                   <form method="POST" action="espace_saul.php">
