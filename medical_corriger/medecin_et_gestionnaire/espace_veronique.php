...
<body>
    ...
    <header class="dashboard-header">
        <h1>BTyApp 🩺 — Dr Veronique Besolo</h1>
    ...
    <main>
            ...
            if (isset($_SESSION['rapport_veronique']) && !empty($_SESSION['rapport_veronique'])) {
                
                // On inverse le tableau pour afficher le message le plus récent tout en haut
                $rapportsInverses = array_reverse($_SESSION['rapport_veronique']);
        ...
        <form class="rapport" action="espace_veronique.php" method="POST">
            ...
            <div class="org">
                <h3>2.  Consultation</h3>
                   ...
                   <form method="POST" action="espace_veronique.php">
